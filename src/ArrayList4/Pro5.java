...
public class Pro5 {
	public static void main(String[] args) {
        ...
        while (iterator.hasNext()) {
            ...
            if (fruit.startsWith("M")) {  // Remove fruits starting with 'M'
                iterator.remove();
            }
        }
        ...
        list.subList(1, 4).clear();  // Remove elements from index 1 to 3
        System.out.println("After range removal: " + list);

...
public class Pro4 {
	public static void main(String[] args) {
     ...
     // === 3. POP OPERATIONS ===
        ...
        System.out.println("remove(2):"+stack.remove(2));
        System.out.println("removeElement(30):"+stack.removeElement(30));//boolean value will be returned
        System.out.println("After pops:"+stack);
        
     // === 4. SEARCH OPERATIONS ===
        System.out.println("\n=== SEARCH ===");
        System.out.println("search(20):"+stack.search(20));
        System.out.println("search(10):"+stack.contains(10));//boolean
     ...
     // === 7. VECTOR INHERITED OPERATIONS ===
        ...
        // === 8. BULK OPERATIONS ===
        System.out.println("\n=== BULK OPERATIONS ===");
        stack.addAll(List.of(300, 400, 500));// to add more than one element
        System.out.println("After addAll:"+stack);
        
        stack.removeAllElements();//Vector
        System.out.println("After removingAllElements:"+stack);
